    ...
    return (
      <div className="w-full">
        ...
        <select
          ref={ref}
          id={selectId}
          className={`block w-full rounded-[2px] border border-mac-black bg-mac-white px-2 py-1.5 text-sm text-mac-black shadow-[inset_1px_1px_0px_#555] focus:outline-none focus:ring-2 focus:ring-mac-black ${
