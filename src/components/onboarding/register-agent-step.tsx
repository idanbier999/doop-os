...
export function RegisterAgentStep({ workspaceId, onComplete }: RegisterAgentStepProps) {
  ...
  if (step === "form") {
    return (
      <div className="space-y-6">
        <div>
          <h2 className="text-xl font-semibold text-mac-black">Register your first agent</h2>
          <p className="mt-1 text-sm text-mac-gray">
            Give your agent a name and select its platform to connect it to Doop.
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-mac-black">Agent registered</h2>
        <p className="mt-1 text-sm text-mac-gray">
      ...
      <div className="rounded-lg border border-amber-400 bg-amber-50 px-3 py-2">
        ...
        <p className="mt-1 text-xs text-amber-700">This key is shown once. Store it safely.</p>
      </div>
