  ...
  return (
    <div className="flex flex-wrap items-end gap-3">
      ...
      <div className="flex gap-2 ml-auto">
        <Button variant="secondary" size="sm" onClick={onExportCSV} disabled={filteredCount === 0}>
          Export CSV
        </Button>
        <Button variant="secondary" size="sm" onClick={onExportJSON} disabled={filteredCount === 0}>
          Export JSON
        </Button>
      </div>
    </div>
