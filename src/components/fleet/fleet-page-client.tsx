...
import { OperatorFleetSummary, type OperatorGroup } from "@/components/fleet/operator-fleet-summary";
...
export function FleetPageClient({
  ...
  const [selectedOperatorId, setSelectedOperatorId] = useState<string | null | undefined>(undefined);
